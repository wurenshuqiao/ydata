...
This library is distributed�ֲ�ʽ�� in the hope that it will be useful,
but WITHOUT ANY WARRANTY��֤��; without even the impliedĬ�ϵ� warranty of
MERCHANTABILITY������ or FITNESS���� FOR A PARTICULAR�ض��� PURPOSEĿ��.  See the GNU
...
/**
 * This class stablishesʹ��� communication����ͨѸ to a remote Http URL using sockets and raw
 * data transmission
 * @package HessianPHP.Http
 * @author Manolo G�mez
 * @copyright Copyright (c) 2005
