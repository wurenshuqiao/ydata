 ...
 * </code>
 * <BR>
 * <B>WARNING:</B> As in PHP 4.3.x, all method name metadata (get_class_methods(), overload extension __call()) is internally内部的 
 * lower-cased so if you call a camel case remote method name, like 'getUsers', the call will result into a no such
 * method fault缺点 because PHP will interpret解释说明 the method name as 'getusers'. This is especially尤其 bad when calling Java
 * services where many method names are camel骆驼 cased. Sad but true.<BR >
 * <BR>
 * To counterfeit仿冒 this, use {@link HessianPHP.Hessian#remoteMethod remoteMethod()}  in the proxy object to tell Hessian how to call the method with the 
 * right name before executing the call. PHP 5 doesn't seem to be affected受到影响 by this behavior.
 * <BR>
 * <BR>
 * <UL>
 *	<LI>SSL support</LI>
