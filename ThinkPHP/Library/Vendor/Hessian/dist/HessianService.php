...
class HessianService{
	 ...
	 * This method uses streams to retrieve恢复 raw POST bytes and a 
	 ...
	 *
	 * As defined in Hessian 1.0 spec, the service requires POST to execute. It is advised明智的 not to call<BR>
	 * any other php code that writes to the default screen output (echo, print, etc.) as it can corrupt损坏
	 * the reply.
	 *  
 	 * @access public 
	 **/
	function service(){
		...
		ob_start(); // apparently显然地 it wins a few milliseconds毫秒
		...
		// uso de streams para obtener获得 informaci髇 cruda del post
